...
dataset = "Semantic_Model_169" # Enter the name or ID of the semantic model
workspace = "FabricWorkspaceuser169" # Enter the workspace name or ID in which the semantic model exists
