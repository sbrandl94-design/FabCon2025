   ...
   AS
   BEGIN
   declare @url varchar(max) = 'https://ai-ready-apps03.openai.azure.com/openai/deployments/text-embedding-ada-002/embeddings?api-version=2024-06-01';
   ...
   begin try
       exec @retval = sp_invoke_external_rest_endpoint
           @url = @url,
           @method = 'POST',
           @credential = [https://ai-ready-apps03.openai.azure.com/],
           @payload = @payload,
